...
class MyWindow(Gtk.ApplicationWindow):
    ...
    def __init__(self, app):
        Gtk.Window.__init__(self, title="Registre d'usuaris", application=app)
        ...
        col = Gtk.TreeViewColumn("Title", cell, text=2)
        col = Gtk.TreeViewColumn("Title", cell, text=3)
        col = Gtk.TreeViewColumn("Title", cell, text=4)
        col = Gtk.TreeViewColumn("Title", cell, text=5)
